...
#include "../SocketProgram/client.h"
...
QT_MOC_LITERAL(1, 7, 16), // "updateClientText"
...
QT_MOC_LITERAL(8, 79, 5) // "bytes"
    ...
    "Client\0updateClientText\0\0message\0"
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Client::updateClientText)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Client::updateClientText(QString _t1)
{
